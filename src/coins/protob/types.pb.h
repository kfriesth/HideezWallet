...
#define MAX_OUT_SCRIPT_PUBKEY 520
#define MAX_IN_SCRIPT_SIG 1650
#define MAX_OP_RETURN_BYTES 80
#define MAX_EXTRA_DATA 1024
#define MAX_SERIALIZED_TX_SIZE 2048
#define MAX_MULTISIG_COUNT 15

#else

#define MAX_OUT_SCRIPT_PUBKEY 32   // pay_to_address is 25 bytes
#define MAX_IN_SCRIPT_SIG 160   // ?
#define MAX_OP_RETURN_BYTES 1
#define MAX_EXTRA_DATA 64
#define MAX_SERIALIZED_TX_SIZE 512
#define MAX_MULTISIG_COUNT 1
...
typedef struct {
    size_t size;
    uint8_t bytes[MAX_OUT_SCRIPT_PUBKEY];
...
typedef struct {
    size_t size;
    uint8_t bytes[MAX_SERIALIZED_TX_SIZE];
...
typedef struct {
    size_t size;
    uint8_t bytes[MAX_IN_SCRIPT_SIG];
...
typedef struct {
    size_t size;
    uint8_t bytes[MAX_OP_RETURN_BYTES];
...
#else
extern const pb_field_t MultisigRedeemScriptType_fields[1];
#endif
